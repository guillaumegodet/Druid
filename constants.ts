...
export const MOCK_RESEARCHERS: Researcher[] = [
  ...
  },
  {
    ...
    status: ResearcherStatus.DEPART,
    employment: {
      employer: 'Université',
      contractType: 'Titulaire',
      grade: 'Professeur',
...
export const MOCK_STRUCTURES: Structure[] = [
  // ÉTABLISSEMENT
  {
    ...
    acronym: 'UE',
    officialName: 'Université Example',
    ...
    city: 'Paris',
    country: 'France',
    website: 'https://www.univ-example.fr',
    email: 'contact@univ-example.fr',
    identifiers: {
      idrefId: '026396486',
    },
    historyLinks: [],
